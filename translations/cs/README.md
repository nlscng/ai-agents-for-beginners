...
>
> Tento repozitář zahrnuje překlady do více než 50 jazyků, což významně zvětšuje velikost ke stažení. Pro klonování bez překladů použijte sparse checkout:
>
> **Bash / macOS / Linux:**
> ```bash
...
**Pokud si přejete podporu dalších jazyků, jsou seznamy podporovaných jazyků uvedeny [zde](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
Tento kurz obsahuje lekce pokrývající základy tvorby AI Agentů. Každá lekce se věnuje svému tématu, takže začněte kdekoliv chcete!

Kurz podporuje více jazyků. Navštivte naše [dostupné jazyky zde](../..).

Pokud stavíte s generativními AI modely poprvé, podívejte se na náš kurz [Generative AI For Beginners](https://aka.ms/genai-beginners), který obsahuje 21 lekcí o tvorbě s GenAI.

Nezapomeňte [označit tento repozitář hvězdičkou (🌟)](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) a [vytvořit fork tohoto repozitáře](https://github.com/microsoft/ai-agents-for-beginners/fork), abyste mohli spustit kód.

### Setkejte se s ostatními studenty, získejte odpovědi na své otázky

Pokud si nebudete vědět rady nebo budete mít jakékoli dotazy ohledně tvorby AI Agentů, připojte se k našemu věnovanému kanálu na Discordu v [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### Co potřebujete

Každá lekce v tomto kurzu obsahuje příklady kódu, které najdete ve složce code_samples. Můžete si [vytvořit fork tohoto repozitáře](https://github.com/microsoft/ai-agents-for-beginners/fork) a vytvořit si tak vlastní kopii.

Příklad kódu v těchto cvičeních využívá Microsoft Foundry a GitHub Model Catalogs pro práci s jazykovými modely:
...
Tento kurz také používá následující rámce a služby AI Agentů od Microsoftu:
...
Pro více informací o spuštění kódu tohoto kurzu navštivte [Course Setup](./00-course-setup/README.md).

## 🙏 Chcete pomoci?

Máte návrhy nebo jste našli chyby v pravopisu či kódu? [Vytvořte issue](https://github.com/microsoft/ai-agents-for-beginners/issues?WT.mc_id=academic-105485-koreyst) nebo [pull request](https://github.com/microsoft/ai-agents-for-beginners/pulls?WT.mc_id=academic-105485-koreyst)
...
- Ukázky kódu v Pythonu podporující Microsoft Foundry a Github Models (Zdarma)
...
| Prozkoumání AI Agentic Frameworks              | [Odkaz](./02-explore-agentic-frameworks/README.md) | [Video](https://youtu.be/ODwF-EZo_O8?si=Vawth4hzVaHv-u0H)  | [Odkaz](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Porozumění AI Agentic Design Patterns          | [Odkaz](./03-agentic-design-patterns/README.md)    | [Video](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Odkaz](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Vzorec využití nástroje                        | [Odkaz](./04-tool-use/README.md)                   | [Video](https://youtu.be/vieRiPRx-gI?si=2z6O2Xu2cu_Jz46N)  | [Odkaz](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Plánovací design pattern                       | [Odkaz](./07-planning-design/README.md)             | [Video](https://youtu.be/kPfJ2BrBCMY?si=6SC_iv_E5-mzucnC)  | [Odkaz](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
| Vzorec multi-agentního designu                  | [Odkaz](./08-multi-agent/README.md)                 | [Video](https://youtu.be/V6HpE9hZEx0?si=rMgDhEu7wXo2uo6g)  | [Odkaz](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst) |
...
| Průzkum Microsoft Agent Framework                         | [Odkaz](./14-microsoft-agent-framework/README.md)                            |                                                            |                                                                                        |
| Tvorba agentů pro použití počítače (CUA)           | Již brzy                            |                                                            |                                                                                        |
...
Náš tým také vytváří další kurzy! Podívejte se na:
...
Díky [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) za příspěvek důležitých ukázek kódu demonstrujících Agentní RAG.

## Přispívání

Tento projekt vítá příspěvky a návrhy. Většina příspěvků vyžaduje, abyste souhlasili s Licenční smlouvou přispěvatele (CLA), která deklaruje, že máte právo a skutečně nám udělujete práva na užití vašeho příspěvku. Pro podrobnosti navštivte <https://cla.opensource.microsoft.com>.

Když odešlete pull request, bot CLA automaticky zjistí, zda potřebujete dodat CLA, a odpovídajícím způsobem označí PR (např. stavová kontrola, komentář). Stačí postupovat podle instrukcí bota. Toto budete muset udělat pouze jednou napříč všemi repozitáři používajícími naši CLA.

Tento projekt přijal [Microsoft Open Source Kodex chování](https://opensource.microsoft.com/codeofconduct/). Pro více informací si přečtěte [Často kladené dotazy k Kodexu chování](https://opensource.microsoft.com/codeofconduct/faq/) nebo kontaktujte [opencode@microsoft.com](mailto:opencode@microsoft.com) s jakýmikoli dalšími otázkami nebo komentáři.

## Ochranné známky

Tento projekt může obsahovat ochranné známky nebo loga projektů, produktů nebo služeb. Autorizované použití ochranných známek nebo log Microsoftu podléhá a musí se řídit [Pravidly používání ochranných známek a značek Microsoftu](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general). Použití ochranných známek nebo log Microsoftu v upravených verzích tohoto projektu nesmí způsobovat záměnu ani naznačovat sponzorství Microsoftu. Jakékoliv použití ochranných známek nebo log třetích stran podléhá zásadám těchto třetích stran.

## Získání pomoci

Pokud narazíte na problémy nebo máte otázky ohledně tvorby AI aplikací, přidejte se:
