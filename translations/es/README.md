...
![IA Generativa Para Principiantes](../../translated_images/es/repo-thumbnailv2.06f4a48036fde647.webp)
...
>
> Este repositorio incluye traducciones en más de 50 idiomas lo cual incrementa significativamente el tamaño de descarga. Para clonar sin las traducciones, usa sparse checkout:
>
> **Bash / macOS / Linux:**
> ```bash
...
**Si deseas que se añadan idiomas adicionales a las traducciones soportadas, están listados [aquí](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**

[![Observadores GitHub](https://img.shields.io/github/watchers/microsoft/ai-agents-for-beginners.svg?style=social&label=Observar)](https://GitHub.com/microsoft/ai-agents-for-beginners/watchers/?WT.mc_id=academic-105485-koreyst)
...
[![Estrellas GitHub](https://img.shields.io/github/stars/microsoft/ai-agents-for-beginners.svg?style=social&label=Estrella)](https://GitHub.com/microsoft/ai-agents-for-beginners/stargazers/?WT.mc_id=academic-105485-koreyst)
...
Este curso tiene lecciones que cubren los fundamentos para construir Agentes de IA. Cada lección cubre un tema propio, ¡así que comienza donde quieras!

Este curso cuenta con soporte multilingüe. Ve nuestros [idiomas disponibles aquí](../..). 

Si es la primera vez que trabajas con modelos de IA Generativa, echa un vistazo a nuestro curso [IA Generativa para Principiantes](https://aka.ms/genai-beginners), que incluye 21 lecciones sobre cómo construir con GenAI.

No olvides [marcar con estrella (🌟) este repositorio](https://docs.github.com/en/get-started/exploring-projects-on-github/saving-repositories-with-stars?WT.mc_id=academic-105485-koreyst) y [forkear este repositorio](https://github.com/microsoft/ai-agents-for-beginners/fork) para ejecutar el código.

### Conoce a Otros Aprendices, Obtén Respuestas a Tus Preguntas

Si te atascas o tienes preguntas sobre cómo construir Agentes de IA, únete a nuestro canal dedicado en Discord en el [Microsoft Foundry Discord](https://aka.ms/ai-agents/discord).

### Lo Que Necesitas

Cada lección en este curso incluye ejemplos de código, que se pueden encontrar en la carpeta code_samples. Puedes [forkear este repositorio](https://github.com/microsoft/ai-agents-for-beginners/fork) para crear tu propia copia.  

El ejemplo de código en estos ejercicios utiliza Microsoft Foundry y Modelos del Catálogo de GitHub para interactuar con Modelos de Lenguaje:

- [Modelos GitHub](https://aka.ms/ai-agents-beginners/github-models) - Gratis / Limitado
- [Microsoft Foundry](https://aka.ms/ai-agents-beginners/ai-foundry) - Requiere Cuenta Azure

Este curso también utiliza los siguientes frameworks y servicios de Agentes de IA de Microsoft:

- [Marco de Agentes de Microsoft (MAF) - ¡Nuevo!](https://aka.ms/ai-agents-beginners/agent-framewrok)
- [Servicio de Agentes AI de Azure](https://aka.ms/ai-agents-beginners/ai-agent-service)
...
- Ejemplos de código Python que soportan Microsoft Foundry y Modelos GitHub (Gratis)
...
| Entendiendo los Patrones de Diseño Agentico  | [Enlace](./03-agentic-design-patterns/README.md)     | [Video](https://youtu.be/m9lM8qqoOEA?si=BIzHwzstTPL8o9GF)  | [Enlace](https://aka.ms/ai-agents-beginners/collection?WT.mc_id=academic-105485-koreyst)  |
...
Acuerdo de Licencia de Contribuyente (CLA) declarando que tienes el derecho y en efecto
nos otorgas los derechos para usar tu contribución. Para más detalles, visita <https://cla.opensource.microsoft.com>.

Cuando envíes un pull request, un bot CLA determinará automáticamente si necesitas proporcionar
un CLA y decorará el PR apropiadamente (por ejemplo, estado, comentario). Simplemente sigue las instrucciones
suministradas por el bot. Solo necesitarás hacer esto una vez en todos los repositorios que usan nuestro CLA.

Este proyecto ha adoptado el [Código de Conducta para Código Abierto de Microsoft](https://opensource.microsoft.com/codeofconduct/).
...
Si te atascas o tienes alguna pregunta sobre cómo construir aplicaciones de IA, únete a:
